...
SELECT
    ...
    MAX( CASE WHEN customers_1.meta_key = 'billing_first_name'         AND customers_1.user_id = customers.id THEN customers_1.meta_value END ) AS first_name,
    MAX( CASE WHEN customers_1.meta_key = 'billing_last_name'            AND customers_1.user_id = customers.id THEN customers_1.meta_value END ) AS last_name,
